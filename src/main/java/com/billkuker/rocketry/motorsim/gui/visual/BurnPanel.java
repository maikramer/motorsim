    ...
    public BurnPanel(Burn b) {
        ...
        try {
            ...
            grain = new GrainPanel(burn.getMotor().getGrain()) {
                ...
                @Override
                protected void addComponents(java.awt.Component crossSection, java.awt.Component slider, java.awt.Component label, java.awt.Component area, java.awt.Component volume) {
